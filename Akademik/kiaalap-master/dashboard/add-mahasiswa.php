                                                    ...
                                                    <form method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="tgl_lahir" id="finish" type="text" class="form-control" placeholder="Date of Birth">
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        if(isset($_POST['simpan'])){
                                                            ...
                                                            $input->inputmahasiswa($nim,$nama,$alamat,$fakultas,$prodi,$semester,$tgl_lahir,$website,$no_hp);
